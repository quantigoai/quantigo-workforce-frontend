...
import ChapterDeleteModal from "../components/Chapter/ChapterDeleteModal";
import ChapterHeaderMenuIndex from "../components/Chapter/ChapterHeaderMenuIndex";
...
const ChapterViewPage = () => {
  ...
  const { courseChapter, isLoading } = useSelector((state) => state.course);
