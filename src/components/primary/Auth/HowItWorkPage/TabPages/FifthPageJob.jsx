      ...
      <Box
        ...
        <Box sx={{ paddingBottom: "0%" }}>
          <Typography variant="subtitle2" sx={{ color: "#FFFFFF" }}>
            ...
            relevant details. If you are interested in taking a job, simply
            click on <b>"Take job" </b> and a confirmation pop-up message will
            appear. You can filter jobs based on your requirements by using the
            filtering options available on the Jobs page.
          </Typography>
        </Box>
        ...
        <Box sx={{ paddingBottom: "1%" }}>
          <Typography variant="subtitle2" sx={{ color: "#FFFFFF" }}>
            ...
            link, and other relevant details.
          </Typography>
        </Box>
        <Box sx={{ paddingBottom: "1%" }}>
          <Typography variant="subtitle2" sx={{ color: "#FFFFFF" }}>
            ...
            change to
            <b> "reviewing" </b>. If the work is not up to the mark, the status
            will turn into <b> "recheck" </b>. If the work is already
            satisfactory, then it will be moved to the archived job section. You
            will have a maximum of 3 attempts to complete the work. if you
            failed three times then that job will also move into{" "}
            <b> "Archived job" </b> as expired. Once a job is archived, it
