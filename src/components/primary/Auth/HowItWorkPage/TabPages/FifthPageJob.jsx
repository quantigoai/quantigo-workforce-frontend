        ...
        {/* <>
          ...
          <Box sx={{ paddingBottom: "0%" }}>
            <Typography variant="subtitle2" sx={{ color: "#47536B" }}>
              Clicking on the <b> Jobs </b> button in the Dashboard navigation will display the available jobs that
              match your skills. Here, you can view the job category, no. of images, time limit and other relevant
              details. If you are interested in taking a job, simply click on <b>"Take job" </b> and a confirmation
              pop-up message will appear. You can filter jobs based on your requirements by using the filtering options
              available on the Jobs page.
            </Typography>
          </Box>
          ...
          <Box sx={{ paddingBottom: "1%" }}>
            <Typography variant="subtitle2" sx={{ color: "#47536B" }}>
              ...
              the work is already satisfactory, then it will be moved to the archived job section. You will have a
              maximum of 3 attempts to complete the work. if you failed three times then that job will also move into{" "}
