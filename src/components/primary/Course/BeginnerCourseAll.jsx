...
const BeginnerCourseAll = () => {
  ...
  const BeginnerCoursesArr = allCourse.filter((course) => course.level === 'beginner');
  return (
    <>
      {isCourseLoading ? (
        <LoadingComponent />
        ...
        <Box className="content">
          <Box className="contentHeader">
            <CourseHeader
              courseCount={BeginnerCoursesArr.length}
              open={open}
              setOpen={setOpen}
...
export default BeginnerCourseAll;
