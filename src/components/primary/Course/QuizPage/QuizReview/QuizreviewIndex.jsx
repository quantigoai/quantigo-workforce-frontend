...
const QuizreviewIndex = () => {
  ...
  console.log("🚀 ~ QuizreviewIndex ~ user:", user.role);
  const [data, setData] = React.useState({});
  const [responses, setResponses] = React.useState();
  console.log("🚀 ~ QuizreviewIndex ~ Responses:", responses);
  ...
  useEffect(() => {
    dispatch(getSingleSubmittedQuiz(id)).then((action) => {
      ...
      console.log(
        "🚀 ~ dispatch ~ action.payload.data.submission.reviewerSubmissionFeedback:",
        action.payload.data.submission.reviewerSubmissionFeedback
      );
    });
  }, []);
                        ...
                        {item.isTextFieldEnabled && (
                          <>
                            ...
                            >
                              ...
                              >
                                {user.role === "admin" || user.role === "trainer" ? "User Given Text" : "  Given Text"}
                              </Typography>
                              <PdTextField
                                fullWidth
                                disabled
