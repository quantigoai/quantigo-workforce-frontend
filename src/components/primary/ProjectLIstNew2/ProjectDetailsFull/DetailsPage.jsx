...
const DetailsPage = () => {
  return (
    <Box sx={style}>
      ...
      <Alert sx={{ borderRadius: "8px", width: "50%", border: "1px solid #F0D8A8", background: "#FFF8EB", mt: 2, color: "#FFAB00", fontSize: "12px", fontWeight: "500", ml: 3 }} variant="filled" severity="info">
