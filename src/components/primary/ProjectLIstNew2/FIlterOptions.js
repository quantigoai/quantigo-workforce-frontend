...
export const projectDirectoryField = [
  ...
  { field: 'remarks', width: 180, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'annotation', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'QA', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'labeling_Tool', width: 180, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'data_Type', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'guideline', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'PDL', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'DL', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'DCR', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'PCR', width: 140, textAlign: 'left', columnDataAlign: 'left' },
  { field: 'completion_Date', width: 200, textAlign: 'left', columnDataAlign: 'left' },
  {
    field: 'ACTIONS',
    renderCell: 'button',
    width: 80,
