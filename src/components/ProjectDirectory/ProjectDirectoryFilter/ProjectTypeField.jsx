...
const ProjectTypeField = ({ projectTypeFieldFilter, setProjectTypeFieldFilter, isLightTheme }) => {
  const [industryAllType, setIndustryAllType] = useState([]);
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(getType("project_Type")).then((action) => {
    ...
    <>
      <FormControl variant="filled" fullWidth>
        ...
        <Select
          ...
          onChange={(e) => setProjectTypeFieldFilter(e.target.value)}
          value={projectTypeFieldFilter || ""}
          sx={{
