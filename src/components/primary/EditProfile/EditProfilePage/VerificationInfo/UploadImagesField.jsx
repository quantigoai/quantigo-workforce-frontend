              ...
              /> */}
                {documentType != "documentType" && (
                  <Typography
                    sx={{
                      color:
                        files?.length === 5 || !editAble || !documentType ? "gray" : isLightTheme ? "#1D1D1D" : "#fff",
                    }}
                    variant="wpf_p3_regular"
                  >
                    {!documentType && "Please Select a Document type for uploading Images."}
                  </Typography>
                )}
                <Typography
                  sx={{
                  ...
                  variant="wpf_p3_regular"
                >
                  Select Here or Drag and Drop for Upload {label} Images (JPG/JPEG/PNG).
                </Typography>
                <Typography
                  sx={{
                    color:
                  ...
                  variant="wpf_p3_regular"
                >
                  Make sure each image is under 1MB and you can upload maximum 5 images.
                </Typography>
                <Typography
                  variant="wpf_p3_regular"
                  sx={{
                ...
                <img
                  style={{
                    width: "30px",
                    filter: files?.length === 5 || !editAble || !documentType ? "grayscale(100%)" : "",
                  }}
                  src={ctaImage}
                />
              </Box>
