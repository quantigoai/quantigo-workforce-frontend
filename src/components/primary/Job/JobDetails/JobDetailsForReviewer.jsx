...
const JobDetailsForReviewer = ({ job }) => {
        ...
        <Box sx={{ padding: "4%" }}>
          <Grid container>
            ...
            <Grid
              ...
              <Grid item xs={7} sx={{ paddingLeft: "20%" }}>
                {job?.job?.id?.activeHub &&
                  job?.job?.id?.activeHub.map((item) => (
                    <>
                      <Box key={item}>
                        <Typography variant="h8" sx={{ color: "#1D1D1D" }}>
                          {item},
            ...
            <Grid
              ...
              <Grid item xs={7} sx={{ paddingLeft: "20%" }}>
                <Typography variant="h8" sx={{ color: "#1D1D1D" }}>
                  {capitalizeFirstLetter(job?.job?.id?.category)}
                </Typography>
              </Grid>
            </Grid>
            <Grid
...
export default JobDetailsForReviewer;
