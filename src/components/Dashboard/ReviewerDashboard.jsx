                    ...
                    <Grid container spacing={2} sx={{ position: "relative", bottom: "2px", "paddingTop": "40px" }}>
                        <Grid xs={6}>
                            ...
                            <Card className="text-center" style={card1style} >
                                <Card.Header as="h5">Reviewer Course</Card.Header>
                                <Card.Body>
                                    <Card.Title>Course  </Card.Title>
                                    <Card.Text>
                                        Quantigo ai Reviewer course
                                    </Card.Text>
                        ...
                        <Grid xs={6}>
                            <Card style={card2style} className="text-center" >
                                <Card.Header as="h5">All Job List</Card.Header>
                                <Card.Body>
                                    <Card.Title>Active Job</Card.Title>
                                    <Card.Text>
                                        Quantigo ai training Job List.
                                    </Card.Text>
                    ...
                    <Grid container spacing={0} sx={{ position: "relative", bottom: "2px", "paddingTop": "30px" }}>
                        <Grid xs={6}>
                            <Card style={card3style}>
                                <Card.Body>
                                    <Card.Title>Reviewer job list</Card.Title>
                                    <Card.Text>
                                        Reviewer job

                                    </Card.Text>
                                    <Button >Reviewer job</Button>
                                </Card.Body>
                        ...
                        <Grid xs={6}>
                            <Card style={card3style}>
                                <Card.Body>
                                    ...
                                    <Button  >Reviewer statistics</Button>
