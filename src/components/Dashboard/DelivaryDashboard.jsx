          ...
          <Grid container spacing={2} sx={{ position: "relative", bottom: "2px", "paddingTop": "40px" }}>
            <Grid xs={6}>
              ...
              <Card className="text-center" style={card1style} >
                <Card.Header as="h5"> Job</Card.Header>
                <Card.Body>
                  <Card.Title> Create Job </Card.Title>
                  <Card.Text>
                    Quantigo ai Create a Job
                  </Card.Text>
            ...
            <Grid xs={6}>
              <Card style={card2style} className="text-center" >
                <Card.Header as="h5">Annotator </Card.Header>
                <Card.Body>
                  <Card.Title>Active Annotator</Card.Title>
                  <Card.Text>
                    Quantigo ai training Annotator  .
                  </Card.Text>
                  <Button>Annotator List</Button>
                </Card.Body>
              </Card>
            </Grid>
            {/* <Grid xs={2}>
