...
const CalculateAnnotations = () => {
  ...
  const handleSearch = (e) => {
    console.log(
      "🚀 ~ file: CalculateAnnotations.jsx:112 ~ handleSearch ~ e:",
      e.target.value
    );
  ...
  useEffect(() => {
    ...
    console.log(
      "🚀 ~ file: CalculateAnnotations.jsx:150 ~ useEffect ~ userName:",
      userName
    );
  }, [totalAnnotationsCount]);
  console.log(classes);
  console.log(userName);
  console.log(totalAnnotationsCount);
  console.log(annotationCsv);
