...
export const { clearUserWorkingProject, updateUserWorkingProject, resetUserSlice, updateLoggedInUserManually, updateSingleUserManually, updateUserEnrollCourse, updateUserCompletedCourse } = userSlice.actions;
