...
const CourseCreateModal = ({ handleClose, open }) => {
  ...
  const onSubmit = (data) => {
    ...
    console.log(
      '🚀 ~ file: CourseCreateModal.jsx:169 ~ preRequisiteCoursesColl ~ preRequisiteCoursesColl:',
      preRequisiteCoursesColl,
    );
    console.log(
      '🚀 ~ file: CourseCreateModal.jsx:155 ~ preRequisiteCoursesColl ~ preRequisiteCourses:',
      preRequisiteCourses,
    );
