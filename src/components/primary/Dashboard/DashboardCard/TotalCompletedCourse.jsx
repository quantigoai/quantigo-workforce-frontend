    ...
    <>
      <Grid container>
        <Paper
          ...
          <Box sx={{ padding: "4%" }}>
            <Grid container>
              <Typography sx={{ color: "#969CAF" }}>Total Completed Courses</Typography>
            </Grid>
            <Grid container sx={{ paddingTop: "4%" }}>
              <Grid item xs={8}>
                <Typography sx={{ color: "##1D1D1D" }} variant="h5">
                  {" "}
                  {totalCountData.requestedUsersCompletedCourses}
                </Typography>
              </Grid>
              {/* <Grid
                container
...
export default TotalCompletedCourse;
